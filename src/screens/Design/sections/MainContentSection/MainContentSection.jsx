    ...
    <section className="flex flex-col items-center gap-16 md:gap-24 lg:gap-32 xl:gap-[244px] w-full max-w-screen-2xl mx-auto px-4 md:px-8 py-16 md:py-20 lg:py-24">
      <div className="flex flex-col items-center gap-16 md:gap-[124px] w-full">
        <div className="flex flex-col max-w-[833px] items-center gap-7 w-full mx-auto">
          <h1 className="text-center [font-family:'Manrope',Helvetica] font-medium text-white text-2xl md:text-4xl lg:text-5xl tracking-[-0.48px] leading-tight md:leading-[56px] px-4">
            See Trending Prompts
          </h1>

          <p className="text-center [font-family:'Poppins',Helvetica] font-normal text-[#ffffff99] text-sm md:text-base tracking-[-0.29px] leading-6 md:leading-[28.8px] px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-7 w-full sm:w-auto">
            <Button
              variant="outline"
              className="h-auto border-[1.4px] border-white bg-transparent text-white hover:bg-white hover:text-black px-6 md:px-[34px] py-3 md:py-3.5 rounded-[55px] gap-2 w-full sm:w-auto transition-all duration-200"
            >
            ...
            <Button className="h-auto bg-white text-black hover:bg-gray-100 px-6 md:px-[34px] py-3 md:py-3.5 rounded-[55px] gap-2 w-full sm:w-auto transition-all duration-200">
      ...
      <div className="flex flex-col items-center gap-16 md:gap-[124px] w-full">
        <div className="flex flex-col max-w-[833px] items-center gap-7 w-full mx-auto">
          <h2 className="text-center [font-family:'Manrope',Helvetica] font-medium text-white text-2xl md:text-4xl lg:text-5xl tracking-[-0.48px] leading-tight md:leading-[56px] px-4">
      ...
      <div className="flex flex-col items-center justify-center gap-7 w-full min-h-[400px] md:min-h-[500px] lg:min-h-[600px] max-w-[1309px] mx-auto px-4">
        <div className="w-full text-center">
          <h2 className="[font-family:'Manrope',Helvetica] font-medium text-xl md:text-3xl lg:text-4xl xl:text-[64px] tracking-[-0.5px] md:tracking-[-1.16px] leading-tight md:leading-[64px] xl:leading-[86.4px] max-w-full text-center px-4">
