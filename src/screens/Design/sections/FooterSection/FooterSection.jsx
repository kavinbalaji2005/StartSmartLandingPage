  ...
  const navigationLinks = [
    {
      ...
      columns: [
        ...
        ["About school", "Gallery", "News", "Contacts"],
      ],
    },
  ];
        ...
        <div className="flex items-start gap-6 self-stretch w-full flex-[0_0_auto] flex-col relative">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-8 sm:gap-24 relative flex-[0_0_auto]">
            <div className="inline-flex flex-col items-start gap-1.5 relative flex-[0_0_auto]">
              {navigationLinks[0].columns[0].map((link, index) => (
                <div
                  key={index}
            ...
            <div className="inline-flex flex-col items-start gap-1.5 relative flex-[0_0_auto]">
              {navigationLinks[0].columns[1].map((link, index) => (
                <div
                  key={index}
                  className={`${
                    index === 0 ? "mt-[-1.00px]" : ""
      ...
      <div className="w-full max-w-screen-2xl mx-auto px-4 md:px-8 lg:px-16">
        <div className="flex w-full items-center justify-between relative flex-[0_0_auto] flex-col sm:flex-row gap-4 sm:gap-0 pt-8 border-t border-[#ffffff1a]">
          ...
          <div className="inline-flex items-center gap-8 relative flex-[0_0_auto]">
            <div className="relative w-fit mt-[-1.00px] opacity-40 [font-family:'Poppins',Helvetica] font-medium text-shades-0 text-xs tracking-[0] leading-[18px]">
              En
            </div>
